          ...
          <div className="relative flex w-full min-w-0 flex-1 items-center justify-center px-8 sm:px-12">
            {prevItem ? (
              <Link
                ...
                className="pointer-events-auto absolute left-0 z-10 hidden h-10 w-10 items-center justify-center rounded-full bg-white text-[#121212] transition-transform hover:scale-105 sm:flex sm:left-4"
              >
            ...
            <motion.div
              ...
              className="relative aspect-[957/856] w-full max-h-[min(856px,62vh)] overflow-hidden rounded-[24px] sm:max-h-[min(856px,70vh)] sm:rounded-[36px]"
            >
              <Image
                src={previewSrc}
                alt={item.title}
            ...
            {nextItem ? (
              <Link
                ...
                className="pointer-events-auto absolute right-0 z-10 hidden h-10 w-10 items-center justify-center rounded-full bg-white text-[#121212] transition-transform hover:scale-105 sm:flex sm:right-4"
              >
            ...
            <div className="pointer-events-auto flex items-center gap-4 sm:hidden">
              {prevItem ? (
                <Link
                  href={`/images/${prevItem.id}`}
                  aria-label={`Previous image: ${prevItem.title}`}
                  className="flex h-10 w-10 items-center justify-center rounded-full bg-white text-[#121212]"
                >
                  <ArrowLeft className="h-4 w-4" strokeWidth={1.5} />
                </Link>
              ) : (
